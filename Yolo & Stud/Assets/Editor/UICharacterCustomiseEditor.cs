...
{
    [CustomEditor(typeof(UIBlendShapeController))]
    public class UICharacterCustomiseEditor : Editor
    {
        public enum State { auto, manual }
        public State state;
        private UIBlendShapeController blendShapeSlider;
        ...
        public override void OnInspectorGUI()
        {
            ...
            blendShapeSlider = (UIBlendShapeController)target;
        ...
        private void GUI_Auto()
        {
            ...
            CharacterCustomisation characterCustomization = GameObject.FindObjectOfType<CharacterCustomisation>();
