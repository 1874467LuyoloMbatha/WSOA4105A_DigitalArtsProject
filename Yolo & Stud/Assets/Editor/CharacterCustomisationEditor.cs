...
namespace StudYolo.Blendshapes
{
    ...
    public class CharacterCustomisationEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var characterCustomization = (CharacterCustomisation)target;
            ...
            if (GUILayout.Button("Create Slider"))
            {
                ...
                var BShapeSlider = sliderGO.GetComponent<UIBlendShapeController>();
                ...
                BlendShapeWrapper blendShape = characterCustomization.GetBlendshape(BShapeSlider.blendShapeName);
